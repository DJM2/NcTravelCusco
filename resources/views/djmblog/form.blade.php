<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('nombre') }}
            {{ Form::text('nombre', $djmblog->nombre, ['class' => 'form-control' . ($errors->has('nombre') ? ' is-invalid' : ''), 'placeholder' => 'Nombre']) }}
            {!! $errors->first('nombre', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('descripcion') }}
            {{ Form::text('descripcion', $djmblog->descripcion, ['class' => 'form-control' . ($errors->has('descripcion') ? ' is-invalid' : ''), 'placeholder' => 'Descripcion', 'maxlength' => 255]) }}
        ...
        <div class="form-group">
            {{ Form::label('img') }}
            {{ Form::file('img', $djmblog->img, ['class' => 'form-control' . ($errors->has('img') ? ' is-invalid' : '')]) }}
